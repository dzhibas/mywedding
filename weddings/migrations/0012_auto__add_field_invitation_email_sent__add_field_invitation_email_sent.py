...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invitation.email_sent'
        db.add_column('weddings_invitation', 'email_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Invitation.email_sent_at'
        db.add_column('weddings_invitation', 'email_sent_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invitation.email_sent'
        db.delete_column('weddings_invitation', 'email_sent')

        # Deleting field 'Invitation.email_sent_at'
        db.delete_column('weddings_invitation', 'email_sent_at')
    ...
    models = {
        ...
        'weddings.invitation': {
            ...
            'email_sent_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
