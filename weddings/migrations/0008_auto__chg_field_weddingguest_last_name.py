...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WeddingGuest.last_name'
        db.alter_column('weddings_weddingguest', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'WeddingGuest.last_name'
        raise RuntimeError("Cannot reverse this migration. 'WeddingGuest.last_name' and its values cannot be restored.")
